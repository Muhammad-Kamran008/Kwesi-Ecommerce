...
import com.example.kwesiecommerce.Authetication.SignUpActivity;
...
import com.example.kwesiecommerce.ui.ManageUsersAdapter;
...
public class ManageUsersFragment extends Fragment implements ManageUsersAdapter.OnUserClickListener {
    ...
    private void showAddUserDialog() {
        ...
        EditText editTextUsername = dialogView.findViewById(R.id.text_add_userUsername);
      ...
      //  Toast.makeText(getActivity(), "profile image " + user.getProfilePicture(), Toast.LENGTH_SHORT).show();
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                int id = user.getId();
                String profilpic = user.getProfilePicture();
                String username = user.getUsername();
                Log.d("image uri", "onClick: " + selectedImageUri);
                if (selectedImageUri != null) {
                    String fileName = "profile_" + username + "." + imageUploadHandler.getFileExtension(requireActivity().getApplicationContext(), selectedImageUri);
                    ...
                    User user = new User(id, firstName, lastName, email, password, phone, memorableWord, address, userType, username, profilpic);
                    long ids = db.updateUser(user);
                    db.updatelastUpdated(email);
                    Log.d("edit", "onClick: " + ids);
                    if (ids == -1) {
