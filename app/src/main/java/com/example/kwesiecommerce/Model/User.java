...
public class User {
    ...
    public User(String firstName, String lastName, String email, String password, String phone, String memorableWord, String address, String userType, String username, String profileImage,String lastUpdated) {
        this.first_name = firstName;
        this.last_name = lastName;
        this.email = email;
        this.password = password;
